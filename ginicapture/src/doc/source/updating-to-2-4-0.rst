...
You can view the Gini Vision Library's hardware requirements `here <http://developer.gini.net/gini-capture-sdk-android/javadoc/net/gini/android/vision/requirements/RequirementId.html>`_.
