...
To use it add the ``gini-capture-network-lib`` dependency to your app's ``build.gradle`` along with
...
.. code-block:: groovy
    ...
    dependencies {
        ...
        implementation 'net.gini:gini-capture-sdk:3.0.0'
        implementation 'net.gini:gini-capture-network-lib:3.0.0'
    }
