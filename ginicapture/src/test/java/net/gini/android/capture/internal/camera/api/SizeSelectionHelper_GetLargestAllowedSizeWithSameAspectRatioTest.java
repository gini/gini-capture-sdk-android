...
import static net.gini.android.capture.internal.camera.api.Resolutions.DECREASING_RESOLUTIONS;
import static net.gini.android.capture.internal.camera.api.Resolutions.INCREASING_RESOLUTIONS;
import static net.gini.android.capture.internal.camera.api.Resolutions.UNSORTED_RESOLUTIONS;
import static net.gini.android.capture.internal.camera.api.Resolutions.assertSizeEqualsResolution;
import static net.gini.android.capture.internal.camera.api.Resolutions.toSize;
import static net.gini.android.capture.internal.camera.api.Resolutions.toSizesList;
